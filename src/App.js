...
//   const [searchType, setSearchType] = useState('comj mpany');
...
//         break;
//       case 'name':
//         url = `https://financialmodelingprep.com/api/v3/search-name?query=${searchQuery}&limit=${limit}&exchange=NASDAQ&apikey=${apiKey}`;
//         break;
//       case 'cik-search':
...
//         // url = `https://financialmodelingprep.com/api/v3/income-statement/income-statement?period=annual&apikey=${apiKey}`;
